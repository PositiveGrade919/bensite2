...
${frame.code}`;
    ...
    "ebWYT": [
        function(require, module, exports) {
            ...
            const slideshow = new _slideshow.Slideshow(document.querySelector(".stack"));
            // Preload images
 ...
 */ (function(window, factory) {
                ...
                if (module.exports) module.exports = factory(window, require("ev-emitter"));
 ...
 */ parcelHelpers.export(exports, "Slideshow", ()=>Slideshow);
            ...
            (0, _gsap.gsap).registerPlugin(_flip.Flip);
            (0, _gsap.gsap).registerPlugin(_observer.Observer);
	 ...
	 */ constructor(DOM_el){
                    ...
                    this.DOM.contentItems.forEach((item)=>this.contentItems.push(new _contentItem.ContentItem(item)));
                    this.initEvents();
                }
                /**
	 * Event binding.
...
*/ _easeMap = {}, _customEaseExp = /^[\d.\-M][\d.\-,\s]/, _quotesExp = /["']/g, _parseObjectInString = function _parseObjectInString(value) {
                ...
                var p1 = amplitude1 >= 1 ? amplitude1 : 1, p2 = (period1 || (type ? .3 : .45)) / (amplitude1 < 1 ? amplitude1 : 1), p3 = p2 / _2PI * (Math.asin(1 / p1) || 0), easeOut = function easeOut(p) {
        ...
        */ if (iteration !== prevIteration && !this._lock) {
            ...
            var _addComplexStringPropTween = function _addComplexStringPropTween(target, prop, start, end, setter, stringFilter, funcParam) {
                ...
                return plugin;
            }, _overwritingTween, _forceAllPropTweens, _initTween = function _initTween1(tween, time) {
 ...
 */ var _gsap = {
                ...
                quickSetter: function quickSetter(target, property, unit) {
                    ...
                    target = target[0] || {};
                    var Plugin = _plugins[property], cache = _getCache(target), p4 = cache.harness && (cache.harness.aliases || {})[property] || property, setter = Plugin ? function(value) {
                        var p = new Plugin();
                        _quickTween._pt = 0;
...
*/ /* eslint-disable */ var _gsapCoreJs = require("./gsap-core.js");
            var _win, _doc, _docElement, _pluginInitted, _tempDiv, _tempDivStyler, _recentSetterPlugin, _windowExists = function _windowExists() {
                ...
                cache = parent._gsap;
                if (cache && toPercent && cache.width && horizontal && cache.time === _gsapCoreJs._ticker.time) return (0, _gsapCoreJs._round)(curValue / cache.width * amount);
                else {
                    ...
                    for(p in vars){
                        ...
                        if (specialProp) specialProp(this, target, p, endValue, tween) && (hasPriority = 1);
                            ...
                            if (startAt && p in startAt) {
                                ...
                                (0, _gsapCoreJs.getUnit)(startValue + "") || (startValue += _gsapCoreJs._config.units[p] || (0, _gsapCoreJs.getUnit)(_get(target, p)) || ""); // for cases when someone passes in a unitless value like {x: 100}; if we try setting translate(100, 0px) it won't work.
                            ...
                            if (isTransformRelated) {
                                ...
                                if (p === "scale") {
                                    this._pt = new _gsapCoreJs.PropTween(this._pt, cache, "scaleY", cache.scaleY, (relative ? (0, _gsapCoreJs._parseRelative)(cache.scaleY, relative + endNum) : endNum) - cache.scaleY || 0);
                                    props.push("scaleY", p);
                                    p += "X";
...
*/ /* eslint-disable */ var _matrixJs = require("./utils/matrix.js");
            var _id = 1, _toArray, gsap, _batch, _batchAction, _body, _closestTenth, _forEachBatch = function _forEachBatch(batch, name) {
                ...
                if (uncache) result = new ElementState(element);
                    ...
                    if (elState.simple) {
                        ...
                        result.matrix = new _matrixJs.Matrix2D(1, 0, 0, 1, bounds.left + (0, _matrixJs._getDocScrollLeft)(), bounds.top + (0, _matrixJs._getDocScrollTop)());
                ...
                run = function run() {
                    ...
                    for(i1 = 0; i1 < comps.length; i1++){
                        ...
                        a = comp1.a;
                        b = comp1.b;
                        if (prune && !a.isDifferent(b) && !comp1.entering) comps.splice(i1--, 1);
                        else {
                            el1 = comp1.t;
                            ...
                            if (comp1.sd || b.isVisible && a.isVisible) {
                                ...
                                } else if (comp1.sd > 0 && fade) el1.style.opacity = interrupted ? a.opacity - b.opacity : "0";
            ...
            var ElementState = /*#__PURE__*/ function() {
                ...
                _proto2.update = function update(props, simple) {
                    var self = this, element = self.element, getProp = gsap.getProperty(element), cache = gsap.core.getCache(element), bounds = element.getBoundingClientRect(), bbox = element.getBBox && typeof element.getBBox === "function" && element.nodeName.toLowerCase() !== "svg" && element.getBBox(), m = simple ? new _matrixJs.Matrix2D(1, 0, 0, 1, bounds.left + (0, _matrixJs._getDocScrollLeft)(), bounds.top + (0, _matrixJs._getDocScrollTop)()) : (0, _matrixJs.getGlobalMatrix)(element, false, false, true);
...
*/ /* eslint-disable */ var _doc, _win, _docElement, _body, _divContainer, _svgContainer, _identityMatrix, _gEl, _transformProp = "transform", _transformOriginProp = _transformProp + "Origin", _hasOffsetBug, _setDoc = function _setDoc(element) {
            ...
            _svgTemps = [], _divTemps = [], _getDocScrollTop = function _getDocScrollTop() {
                ...
                if (element && element.nodeType === 1) return _isFixed1(element);
...
*/ /* eslint-disable */ var gsap, _coreInitted, _clamp, _win, _doc, _docEl, _body, _isTouch, _pointerType, ScrollTrigger, _root, _normalizer, _eventTypes, _getGSAP = function _getGSAP() {
    ...
    "cVgJb",
    "ebWYT"
], "ebWYT", "parcelRequire348c");

//# sourceMappingURL=index.1d64f60f.js.map
